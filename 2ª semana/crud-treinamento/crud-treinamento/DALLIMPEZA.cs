...
namespace crud_treinamento
{
    public class DALLIMPEZA
    {
        ...
        public List<Produto> GetTodosRegistrosProdutoLimpeza()
        {
       ...
       public DataTable GetRegistroPorIdProdutoLimpeza(int id)
        {
       ...
       public int InserirRegistroProdutoLimpeza(string nome, double preco, string marca, string tipo)
        {
            try
            {
                using (conexaobd.pgsqlConnection = new NpgsqlConnection(conexaobd.connString))
        ...
        public void AtualizarRegistroProdutoLimpeza(int id, string nome, double preco, string marca)
            {
            try
            {
                using (conexaobd.pgsqlConnection = new NpgsqlConnection(conexaobd.connString))
